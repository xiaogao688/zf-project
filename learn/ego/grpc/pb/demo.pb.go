...
const file_demo_proto_rawDesc = "" +
	...
	"\vDemoService\x121\n" +
	"\bSayHello\x12\x10.pb.HelloRequest\x1a\x11.pb.HelloResponse\"\x00B\aZ\x05./;pbb\x06proto3"
...
var file_demo_proto_depIdxs = []int32{
	0, // 0: pb.DemoService.SayHello:input_type -> pb.HelloRequest
	1, // 1: pb.DemoService.SayHello:output_type -> pb.HelloResponse
